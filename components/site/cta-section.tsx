          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.4fr_1fr] lg:items-end">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  href={primary.href}
                  className="inline-flex items-center gap-1.5 rounded-full bg-brand-red px-5 py-3 text-sm font-medium text-white transition-all hover:bg-brand-red-dark hover:shadow-lg hover:shadow-brand-red/30 hover:-translate-y-0.5 active:translate-y-0"
                >
                  {primary.label} <ArrowUpRight className="h-4 w-4" />
                </Link>
                <Link
                  href={secondary.href}
                  className="inline-flex items-center gap-1.5 rounded-full border border-brand-ink/20 bg-white px-5 py-3 text-sm font-medium text-brand-ink transition-all hover:border-brand-ink/40 hover:-translate-y-0.5 active:translate-y-0"
                >
                  {secondary.label}
                </Link>
              </div>
