...
const BLOCKS = [
  {
    tag: "01",
    title: "Early Intervention / Pre-Academic",
    subtitle: "Ages 3–6 · School",
    items: ["Motor Skills", "Visual Perceptual Skills"],
  },
  {
    tag: "02",
    title: "Academic / Functional Academic",
    subtitle: "Ages 6–14 · School",
    items: ["Visual Perceptual Skills", "Pratham", "NIOS", "Individualised Education Programme (IEP)"],
  },
  {
    tag: "03",
    title: "Pre-Vocational",
    subtitle: "Ages 14–17 · School",
    items: ["Pre-Work Skills"],
  },
  {
    tag: "04",
    title: "Workshop Functional Academics",
    subtitle: "Ages 18+ · Workshop",
    items: ["Basic Reading", "Writing", "Maths", "Time & Money Management"],
  },
  {
    tag: "05",
    title: "Vocational / Work Skills Training",
    subtitle: "Ages 18+ · Workshop",
    items: [
      "Handicrafts — Paper & cloth bags, envelopes, diyas, torans, table mats, soaps, block printing",
      "Bakery — Chocolates, cakes, cookies",
      "Office Skills — Filing, printing, organisation, computer skills, social skills, work behaviour",
    ],
  },
]
